...
## The Qibo Ecosystem: Integrating Advanced QML with Real-Time Hardware Control
<br>
...
<div class="flex justify-center">
  <img src="/tii_setup.png" class="w-3/4">
</div>
...
# Deploy on many devices: even selfhosted QPUs!
...
<div v-click=[2] class="flex flex-col space-y-2" v-motion
  ...
  <div class="flex justify-end">
	...
	<img src="https://d29g4g2dyqv443.cloudfront.net/sites/default/files/akamai/nvidia-cuquantum-icon.svg" width=24/>
...
<div class="grid grid-cols-[1fr_2fr] gap-4 items-stretch">

<div>
	<img src="/quantum_computer_stack.png" width=300>
</div>
<v-clicks>
	
- <b>High Level</b>: device-agnostic model definition
  <br>
  <img src="/example_circuit.svg" width="250"/>
- <b>Intermediate Level</b>: transpilation to the device-specific topology and native gates set
  <br>
  <img src="/transpiled_circuit.png" width="700"/>
- <b>Low Level</b>: gate compilation into microwave pulses
  <br>
  <img src="/gate_pulse.png" width="400"/>
...
# How do you know what pulse to send?

<v-click> <h2>You Don't.</h2> </v-click> 
<v-click> <h2> &#8594; Calibration is needed.</h2> </v-click>

<br>



<div v-click class="grid grid-cols-[1fr_1fr] gap-4 items-stretch">

<div>
<br>
<h3>The <b>Qibocal</b> pipeline</h3>
<br>
<img src=/qibocal_routine.png>
</div>
...
# A Qibocal Example Report

<div class="flex justify-center">
  <img src="/qibocal_report.png">
</div>
...
<div>
<img src="/single_qubit_rb.png" width=400>
</div>

<div>
<img src="/single_qubit_readout_and_t.png" width=300>
</div>
